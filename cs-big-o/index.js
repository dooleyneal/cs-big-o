...
// ANSWER: const findFourth = numbers => numbers[3]
...
// ANSWER: const getNumbersSquared = numbers => numbers.foreach(element => element * element)
...
// ANSWER: The size of the input string is the only variable in the space complexity.
